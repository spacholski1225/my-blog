...
const Hero = () => {
  return (
    <div className="portfolio-hero">
      <div className="portfolio-hero-content flex flex-col items-center">
        <div className="avatar-container mb-6 flex justify-center w-full">
          <Image
        ...
        <div className="bio-container text-center w-full">
          ...
          <div className="social-links justify-center">
            ...
            <Link href="mailto:your.email@example.com" className="social-button email">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
